...
public class CalendrierCTRController {
    ...
    public void validateEvenement(Evenement eventSelected) throws IOException, EmailException, MalformedURLException {
        ...
        if (CalendarServices.getInstance().addEvent(eventSelected)) {
    ...
    public void deleteEvenement(Evenement eventSelected) {
        mModel.deleteEvent(eventSelected);
    }
}
