package org.jluc.ctr.tools.calendrier.tools.mail.pwd;
...
public class PwdUtils {
    ...
    private Logger mLogger = LogManager.getLogger(PwdUtils.class);
    private static PwdUtils mInstance;
    private static File mPwdFile = new File("resources/ctr.pwd");
    ...
    public synchronized List<StructPwd> readPwdFile() {
        ...
        try {
            FileInputStream fis = new FileInputStream(mPwdFile);
