...
public class InitBDD {
	...
	public static String initDemandeurs() {
		...
		strB.append(
				"INSERT INTO Demandeurs (UUID, Name, NumeroStructure) VALUES ('798256e1-5468-4e46-a4be-dbac41be9455', 'CTD 22', '03 22 00 00');"
	...
	public static String initTypesEvenements() {
		StringBuilder strB = new StringBuilder();
		strB.append(
				"INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('b78a75e9-da16-48db-ad63-83fb81e2ba92','Stage final GP',0,'Stage GP-N4 (Information)');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('6dd89a9e-6042-49e8-965c-0ac5e5d58072','Stage Initial Initiateur',1,'Déclaration de stage initial Initiateur');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('9e353bf2-ca63-4596-9afc-2dc00bb17c71','TSI',2,'Déclaration de stage TSI');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('b5798ee6-6478-4159-a23c-aa661f32de08','Examen Initiateur',1,'Déclaration d''examen Initiateur');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('d46e537b-66b4-4a7a-99b1-0046de1a613e','Examen GP',0,'Déclaration d''examen GP-N4');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('8e721101-6bd1-49c3-a47c-fc7f33ac504a','Module 6-20',1,'Demande de module complémentaire 6-20m');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('cd94785b-7c9b-472c-bd65-4c9440c0cf45','Module 20-40',1,'Demande de module complémentaire 20-40m');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('ab153104-b6de-4511-a20d-543c89db3a8a','Stage Initial MF1',3,'Stage Initial MF1 (CTR-Délégation)');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('b9e1e075-62c8-408b-94ca-c069b7f3e753','Stage final MF1',3,'Stage Final MF1 (CTR)');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('d9ce67af-abc8-4cf2-8bb9-f120bed69888','Examen MF1',3,'Examen MF1 (CTR)');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('ca6ec215-41fb-4e01-a719-8ae05c6d8fd9','TIV Initial',5,'TIV');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('57cca574-481a-4c14-ac73-8ef0d21994f2','TIV Recyclage',5,'TIV Recyclage');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('eefb4eec-4124-4a83-89ab-175fc2708970','ANTEOR',6,'ANTEOR');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('d04834ab-73ab-4225-86cf-abeff5ee284f','RIFAP',6,'RIFAP (Information)');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('2da57ce2-b14a-4c69-9c23-aa3314f73bc7','THA',0,'Théorie Anticipée (CTR)');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('739c2fd2-668f-45ef-9501-6c7165517f49','HANDI PESH 6',7,'Handi PESH 6');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('7ea4e7da-d06a-4cb7-89e3-89b62bc51e9d','HANDI PESH 12',7,'Handi PESH 12');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('43d51248-5d2f-4239-865d-03e38060f952','HANDI PESH 20',7,'Handi PESH 20');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('061eac89-b907-4c9a-9620-17bc1146c8a7','HANDI PESH 40',7,'Handi PESH 40');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('00df7cb1-b592-45c1-b11f-1bed3825f775','HANDI EH1',7,'Handi EH1');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('aa0d64d8-f285-4187-9ec3-d512af7faad8','HANDI EH2',7,'Handi EH2');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('bfdb374d-1622-4a78-afd9-d60b8466b30d','HANDI MFEH1',7,'Handi MF EH1');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('5b2e6f9c-62a7-4b19-af3a-927f71fe527d','HANDI MFEH2',7,'Handi MF EH2');"
						+ "INSERT INTO TypesEvenements (UUID, Name, Type, Valeur) VALUES ('5734fbd1-1a23-4c49-971f-0394e8cbb222','HANDI MPC',7,'Handi Module MPC');");
		return strB.toString();
	}
	...
	public static String initMoniteurs() {
		StringBuilder strB = new StringBuilder();
		strB.append(
				"INSERT INTO Moniteurs (UUID,LastName,FirstName,Niveau) VALUES ('53edb9f0-827b-465f-b4bf-2778d127c36c','REDUREAU','Jean-Yves',3);"
