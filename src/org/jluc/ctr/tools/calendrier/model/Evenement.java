...
public class Evenement implements Comparable<Evenement> {
    ...
    public Evenement(Date dateDemande, Date dateDebut, Date dateFin, TypeEvenement type, Demandeur demandeur, Demandeur partenaire, String mail, String lieu, String comment) {
    ...
    public Evenement(String uuid, Date dateDemande, Date dateDebut, Date dateFin, TypeEvenement type, Demandeur demandeur, Demandeur partenaire, String mail, String lieu, ClubStructure organisateur,
            String comment) {
        mDateDemande = dateDemande;
        mDateDebut = dateDebut;
        mDateFin = dateFin;
    ...
    public Evenement(Date dateDemande, Date dateDebut, Date dateFin, String type, String demandeur, String partenaire, String mail, String lieu, String organisateur, String comment) {
        mDateDemande = dateDemande;
        mDateDebut = dateDebut;
        mDateFin = dateFin;
